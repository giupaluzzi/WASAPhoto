...
func (db *appdbimpl) CommentPhoto(photo Photo, user User, comment Comment) (int, error) {
...
func (db *appdbimpl) UncommentPhoto(photo Photo, user User, comment Comment) error {
